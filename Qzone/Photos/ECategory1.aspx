<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ECategory1.aspx.cs" Inherits="Photos_ECategory1" %>
...
<asp:Repeater ID="category" runat="server" OnItemCommand="category_ItemCommand">
        <ItemTemplate>
          <br />
              ...
              <asp:Button ID="btndelete" Text="删除" OnClientClick="return confirm('如果删除该分类，该分类下的所有相册都将被删除，请问还继续删除么？')" runat="server"  CommandName="delete" CommandArgument='<%# Eval("Id") %>' />&nbsp;
        </ItemTemplate>
    </asp:Repeater>
    <br />
    <br />
